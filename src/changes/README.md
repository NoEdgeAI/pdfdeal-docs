...
- Uploading images to image hosting now supports automatic renaming of filenames using UUID [🔍View usage example](../guide/Tools/MD_imgs.md) [#60](https://github.com/NoEdgeAI/pdfdeal/issues/60) by [@Chen571428](https://github.com/Chen571428)
...
- Uploading MD images to image hosting now supports using path format (uploaded in the form of `/{PDF name}/{image md5}.{extension}`), [🔍View usage example](../guide/Tools/MD_imgs.md) [#53](https://github.com/NoEdgeAI/pdfdeal/issues/53)
...
## V0.4.9
### ✨ New Features
- Introduced a new built-in upload tool: MinIO. You can easily upload images from Markdown documents (whether online links or local links) to MinIO and replace them with links generated by MinIO. [🔍View usage example](../guide/Tools/Upload.md#minio) by [@Huxb12138](https://github.com/Huxb12138) in [#51](https://github.com/NoEdgeAI/pdfdeal/pull/51)

### 🚀 Other
- Added some [example code](https://github.com/NoEdgeAI/pdfdeal/tree/main/examples)
...
- Documentation updated to a separate repository [pdfdeal-docs](https://github.com/NoEdgeAI/pdfdeal-docs)
- Updated unit tests
